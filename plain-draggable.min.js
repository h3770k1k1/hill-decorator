	...
	function (t, e, n) {
		...
		var c = {
			...
			remove: function (t) {
				var e;
				(e = u(t)) > -1 &&
					(o.splice(e, 1), !o.length && r && (a.call(window, r), (r = null)));
			},
		};
		function d(t, e) {
								...
								(e.startHandlers[++e.lastHandlerId] = function (n) {
									...
									if ("touch" === i)
										(e.lastTouchTime = a),
											...
											(o = n.changedTouches[0].identifier);
									else {
					...
					},
					{
						...
						value: function (t, e) {
							if (!this.startHandlers[e])
								throw new Error("Invalid handlerId: ".concat(e));
							return (
								p(t, "mousedown", this.startHandlers[e], {
									capture: !1,
									passive: !1,
								}),
								p(t, "touchstart", this.startHandlers[e], {
									capture: !1,
									passive: !1,
								}),
								p(t, "dragstart", g, { capture: !1, passive: !1 }),
								e
							);
						},
					},
							...
							var n = this,
								r = c.add(function (t) {
									...
									if (
										...
										var r =
											"touch" === e ? h(t.changedTouches, n.curTouchId) : t;
										m(r) &&
		...
		function A(t, e, n) {
			n.filter(function (e) {
				var n;
				return (
					!(!(e = X(e)) || -1 === (n = t.indexOf(e))) && (t.splice(n, 1), !0)
				);
			}).length && Y(t, e);
		}
		function F(t) {
			return (
				...
				(n = {
					...
					add: function () {
						return (
							L(e, t, Array.prototype.slice.call(arguments)),
							F.methodChain ? n : void 0
						);
					},
					remove: function () {
						return (
							A(e, t, Array.prototype.slice.call(arguments)),
							F.methodChain ? n : void 0
						);
					},
					toggle: function (n, r) {
						return (function (t, e, n, r) {
							...
							return -1 !== o
								? !!r || (t.splice(o, 1), Y(t, e), !1)
								: !1 !== r && (t.push(n), Y(t, e), !0);
						})(e, t, n, r);
					},
				...
				function (t) {
					...
					return (
						...
						(!(e = Object.getPrototypeOf(t)) ||
							((n = e.hasOwnProperty("constructor") && e.constructor) &&
								"function" == typeof n &&
								z.call(n) === N))
					);
				}),
				...
				};
		{
			...
			(St.move = function (t, e, n) {
				Tt.call(window, Ot),
					kt(),
					Bt === t &&
						(e.x && Ht.x && (e.x.lastValue = Ht.x.lastValue),
						e.y && Ht.y && (e.y.lastValue = Ht.y.lastValue)),
					(Bt = t),
					(Ht = e),
					(Ct = n);
				var r = Date.now();
		...
		function Xt(t, e) {
			...
			return (
				R(t) !== R(e) ||
				(n = dt(t) ? "obj" : Array.isArray(t) ? "array" : "") !=
					(dt(e) ? "obj" : Array.isArray(e) ? "array" : "") ||
				("obj" === n
		...
		function Lt(t) {
			...
			if (((t.top = t.y = e), ft(t.width) && t.width >= 0))
			...
			return ft(t)
				...
				? (function (t) {
						var e,
							n,
							r = /^(.+?)(%)?$/.exec(t);
						return r && ft((e = parseFloat(r[1])))
							? { value: (n = !(!r[2] || !e)) ? e / 100 : e, isRatio: n }
							: null;
				  })(t.replace(/\s/g, ""))
				: null;
		}
		...
		function jt(t) {
			...
			if (((t.top = t.y = e), (e = At(t.width)) && e.value >= 0))
		...
		function Nt(t, e) {
			null == U &&
				(!1 !== yt && (U = D.getValue("cursor", yt)), null == U && (U = !1)),
				(t.style.cursor = !1 === U ? e : U);
		}
		function Vt(t) {
			null == Z &&
				(!1 !== vt && (Z = D.getValue("cursor", vt)), null == Z && (Z = !1)),
				!1 !== Z && (t.style.cursor = Z);
		}
		function Gt(t, e, n) {
			var r = t.svgPoint;
			return (
		...
		function qt(t, e) {
			...
			if (e.left !== n.left || e.top !== n.top) {
				var r = t.htmlOffset;
				return (
					(t.elementStyle[K] = "translate("
						.concat(e.left + r.left, "px, ")
						.concat(e.top + r.top, "px)")),
					!0
				);
			}
			return !1;
		...
		function Zt(t, e) {
			...
			if (e.left !== n.left || e.top !== n.top) {
				...
				return (
					t.svgTransform.setTranslate(i.x + r.x - o.x, i.y + r.y - o.y), !0
				);
			}
			return !1;
		}
		...
		function Jt(t) {
			...
			return (
				(n[K] = "translate("
					.concat(r.left + c.left, "px, ")
					.concat(r.top + c.top, "px)")),
				["width", "height"].forEach(function (r) {
					u[r] !== l[r] &&
						((n[r] = l[r] + "px"),
						(u = zt(e))[r] !== l[r] && (n[r] = l[r] - (u[r] - l[r]) + "px")),
						(t.lastStyle[r] = n[r]);
				}),
				e.offsetWidth,
				(n[J] = i),
				(a.left === r.left && a.top === r.top) ||
					(n[K] = "translate("
						.concat(a.left + c.left, "px, ")
						.concat(a.top + c.top, "px)")),
				a
			);
		}
		function Kt(t) {
			...
			return (
				...
				["width", "height"].forEach(function (r) {
					s[r] !== l[r] &&
						((n[r] = l[r] + "px"),
						(s = zt(e))[r] !== l[r] && (n[r] = l[r] - (s[r] - l[r]) + "px")),
						(t.lastStyle[r] = n[r]);
				}),
				e.offsetWidth,
				(n[J] = i),
				(a.left === r.left && a.top === r.top) ||
					((n.left = a.left + u.left + "px"), (n.top = a.top + u.top + "px")),
				a
			);
		}
		function Qt(t) {
		...
		function te(t, e) {
			var n = zt(document.documentElement),
				...
				o = (t.containmentBBox = t.containmentIsBBox
					? Mt(t.options.containment, n) || n
					: zt(t.options.containment, !0));
			if (
				((t.minLeft = o.left),
						...
						function p(n) {
							if (
								...
								(n.x = Wt(n.x, d.x, f.x)),
									(n.y = Wt(n.y, d.y, f.y)),
									n.center &&
										((n.x -= i.x / 2), (n.y -= i.y / 2), (n.corners = ["tl"])),
									(n.corners || e.corners).forEach(function (e) {
										...
										if (r >= a.x && r <= l.x && o >= a.y && o <= l.y) {
											var s = { x: r, y: o },
												...
												d = o - n.yGravity,
												f = o + n.yGravity;
											u > a.x && (s.gravityXStart = u),
												c < l.x && (s.gravityXEnd = c),
												d > a.y && (s.gravityYStart = d),
												f < l.y && (s.gravityYEnd = f),
												t.push(s);
										}
									});
							else {
								...
								if (
									((n[r] = Wt(n[r], d[r], f[r])),
									(n[s] = Wt(n[s], d[o], f[o])),
									(n[u] = Wt(n[u], d[o], f[o]) - i[o]),
									n[s] > n[u] || n[s] > l[o] || n[u] < a[o])
								)
									return;
			...
			if (d) {
				...
				var f = "scroll" === e,
					p = (function (t, e, n) {
						var r,
							...
							a,
							l = {};
						(a = e ? document.documentElement : t),
							(l.clientWidth = a.clientWidth),
							(l.clientHeight = a.clientHeight);
						var s,
							u,
							c,
							d = 0,
						...
						return (
							...
							e
								...
								: ((c = t.getBoundingClientRect()),
								  ...
								  (l.clientX = c.left + (parseFloat(i.borderLeftWidth) || 0)),
								  (l.clientY = c.top + (parseFloat(i.borderTopWidth) || 0))),
							l
						);
				...
				f
					? t.autoScroll &&
					  ((c.scrollWidth = t.autoScroll.scrollWidth),
					  (c.scrollHeight = t.autoScroll.scrollHeight))
					: ((c.scrollWidth = p.scrollWidth),
					  (c.scrollHeight = p.scrollHeight)),
					[
						["X", "Width", "left", "right"],
						["Y", "Height", "top", "bottom"],
					].forEach(function (t) {
						...
						if (l < s && l < a) {
							...
							for (
								var u = [],
									f = r[n.toLowerCase()],
									m = d.sensitivity.length - 1;
								m >= 0;
								m--
							) {
								var g = d.sensitivity[m],
									y = d.speed[m];
								u.push({ dir: -1, speed: y, position: h[o] + g }),
									u.push({ dir: 1, speed: y, position: h[i] - g - f });
							}
		...
		function ee(t) {
			...
			bt && e.remove(bt),
				...
				mt.cancel(),
				t.onDragEnd &&
					t.onDragEnd({ left: t.elementBBox.left, top: t.elementBBox.top });
		}
		function ne(t, e) {
			var n,
				r,
			...
			e.containment &&
				(Yt(e.containment)
					? e.containment !== o.containment &&
					  ((o.containment = e.containment),
					  (t.containmentIsBBox = !1),
					  (n = !0))
					: (r = jt(Dt(e.containment))) &&
					  Xt(r, o.containment) &&
					  ((o.containment = r), (t.containmentIsBBox = !0), (n = !0)));
			function i(t, e) {
				function n(t) {
				...
				var s = n(e.edge);
				s &&
					("inside" === s || "outside" === s || "both" === s
						? (t.edge = s)
						: ("inside outside" !== s && "outside inside" !== s) ||
						  (t.edge = "both"));
				var u = "string" == typeof e.base ? e.base.trim().toLowerCase() : null;
				return (
					!u || ("containment" !== u && "document" !== u) || (t.base = u), t
				);
			}
			if (null != e.snap) {
				var a =
						dt(e.snap) && null != e.snap.targets ? e.snap : { targets: e.snap },
					l = [],
					s = i({ targets: l }, a);
				s.gravity || (s.gravity = 20),
					s.corner || (s.corner = "tl"),
					s.side || (s.side = "both"),
					"boolean" != typeof s.center && (s.center = !1),
					s.edge || (s.edge = "both"),
					s.base || (s.base = "containment");
				var u = (Array.isArray(a.targets) ? a.targets : [a.targets]).reduce(
					function (t, e) {
						if (null == e) return t;
						var n,
							r = Yt(e),
							...
							a =
								r || o
									? { boundingBox: e }
									: dt(e) && null == e.start && null == e.end && null == e.step
									? e
									: { x: e, y: e },
							u = [],
							c = {},
						...
						if (r || Yt(d)) u.push({ element: d }), (c.boundingBox = d);
							...
							u.push({ ppBBox: n }), (c.boundingBox = Rt(n));
						else {
							var f,
								p = ["x", "y"].reduce(function (t, e) {
									...
									(n = At(l))
										...
										: (dt(l) &&
										  ...
										  i &&
												((i.isRatio ? i.value > 0 : i.value >= 2)
													? ((t["".concat(e, "Step")] = i), (c[e].step = Ft(i)))
													: (f = !0)));
									return t;
								}, {});
							if (f) return t;
				...
				u.length &&
					((o.snap = s),
					Xt(u, t.parsedSnapTargets) && ((t.parsedSnapTargets = u), (n = !0)));
			} else
				e.hasOwnProperty("snap") &&
					t.parsedSnapTargets &&
					(o.snap = t.parsedSnapTargets = t.snapTargets = void 0);
			if (e.autoScroll) {
				var c = dt(e.autoScroll)
						? e.autoScroll
				...
				(d.sensitivity = d.speed.map(function (t, e) {
					...
					["X", "Y"].forEach(function (t) {
						var e = "min".concat(t),
							n = "max".concat(t);
						ft(c[e]) && c[e] >= 0 && (d[e] = c[e]),
							ft(c[n]) && c[n] >= 0 && (!d[e] || c[n] >= d[e]) && (d[n] = c[n]);
					}),
					Xt(d, o.autoScroll) && ((o.autoScroll = d), (n = !0));
			} else
				e.hasOwnProperty("autoScroll") &&
					(o.autoScroll && (n = !0), (o.autoScroll = void 0));
			if ((n && te(t), Yt(e.handle) && e.handle !== o.handle)) {
				o.handle &&
					((o.handle.style.cursor = t.orgCursor),
					Q && (o.handle.style[Q] = t.orgUserSelect),
					mt.removeStartHandler(o.handle, t.pointerEventHandlerId));
				var p = (o.handle = e.handle);
				(t.orgCursor = p.style.cursor),
					Nt(p, t.orgCursor),
					Q && ((t.orgUserSelect = p.style[Q]), (p.style[Q] = "none")),
					mt.addStartHandler(p, t.pointerEventHandlerId);
			}
			(ft(e.zIndex) || !1 === e.zIndex) &&
				((o.zIndex = e.zIndex),
				t === V &&
					(t.elementStyle.zIndex = !1 === o.zIndex ? t.orgZIndex : o.zIndex));
			var h,
			...
			ft(e.left) && e.left !== m.left && ((m.left = e.left), (h = !0)),
				...
				["onDrag", "onMove", "onDragStart", "onMoveStart", "onDragEnd"].forEach(
					function (n) {
						"function" == typeof e[n]
							? ((o[n] = e[n]), (t[n] = o[n].bind(t.ins)))
							: e.hasOwnProperty(n) && null == e[n] && (o[n] = t[n] = void 0);
					}
				);
		}
		var re = (function () {
			function t(e, n) {
				...
				if (
					(Object.defineProperty(this, "_id", { value: ++gt }),
					(r._id = this._id),
					(pt[this._id] = r),
					!Yt(e) || e === q)
				)
				...
				if (e instanceof SVGElement && (o = e.ownerSVGElement)) {
					...
					(r.svgTransform = e.transform.baseVal.appendItem(
						o.createSVGTransform()
					)),
						(r.svgPoint = o.createSVGPoint());
					var l = e.nearestViewportElement;
					(r.svgCtmElement = st
						? l.appendChild(document.createElementNS(o.namespaceURI, "rect"))
						: l),
						(a = !1),
						(r.initElm = Qt),
						(r.moveElm = Zt);
					...
					s && (a = !1),
						!n.leftTop && K
							? (s && (e.style[s] = "transform"),
							  (r.initElm = Jt),
							  (r.moveElm = qt))
							: (s && (e.style[s] = "left, top"),
							  (r.initElm = Kt),
							  (r.moveElm = Ut));
				}
				...
				(r.pointerEventHandlerId = mt.regStartHandler(function (t) {
					return (function (t, e) {
						return (
							...
							Vt(t.options.handle),
							(q.style.cursor =
								Z || window.getComputedStyle(t.options.handle, "").cursor),
							!1 !== t.options.zIndex &&
							...
							yt !== t &&
								...
								Object.keys(pt).forEach(function (t) {
									...
									e.disabled ||
										...
										e === V &&
											((q.style.cursor = $),
											(q.style.cursor = window.getComputedStyle(
												e.options.handle,
												""
											).cursor)));
								}));
						...
						set: function (t) {
							vt !== t &&
								...
								V &&
									(Vt(V.options.handle),
									!1 === Z &&
										(Nt(V.options.handle, V.orgCursor), (q.style.cursor = $)),
									(q.style.cursor =
										Z ||
										window.getComputedStyle(V.options.handle, "").cursor)));
						},
					},
					{
						key: "draggableClass",
				...
				(n = [
					{
						...
						value: function () {
							var t = pt[this._id];
							(this.disabled = !0),
								mt.unregStartHandler(
									mt.removeStartHandler(
										t.options.handle,
							...
							(t = !!t) !== e.disabled &&
								...
								e.disabled
									? (e === V && ee(e),
									  ...
									  Q && (e.options.handle.style[Q] = e.orgUserSelect),
									  xt && W(e.element).remove(xt))
									: (Nt(e.options.handle, e.orgCursor),
									  Q && (e.options.handle.style[Q] = "none"),
		...
		mt.addMoveHandler(document, function (t) {
			if (V) {
				var e = {
					left: t.clientX + window.pageXOffset + ht.left,
					top: t.clientY + window.pageYOffset + ht.top,
				};
				if (
					$t(
						V,
							...
							? function (t) {
									...
									for (e = 0; e < n && (!r || !o); e++) {
										...
										(null == i.gravityXStart || t.left >= i.gravityXStart) &&
											...
											(r || null == i.x || ((t.left = i.x), (r = !0), (e = -1)),
											o || null == i.y || ((t.top = i.y), (o = !0), (e = -1)));
									}
					...
					if (r) {
						var o = {
							x: V.elementBBox.left - window.pageXOffset,
							y: V.elementBBox.top - window.pageYOffset,
						};
						["x", "y"].forEach(function (t) {
							if (r[t]) {
								var e = r[t].min,
					...
					n.x || n.y
						? (St.move(r.target, n, r.isWindow ? It : _t), (e.autoScroll = !0))
						: St.stop(),
						G ||
							((G = !0),
							bt && W(V.element).add(bt),
							V.onMoveStart && V.onMoveStart(e)),
						V.onMove && V.onMove(e);
				}
			}
		});
		...
		{
			function ie() {
				(J = D.getName("transitionProperty")),
					(K = D.getName("transform")),
					($ = q.style.cursor),
					(Q = D.getName("userSelect")) && (tt = q.style[Q]);
				var t,
					e = {};
				function n(t, e) {
					t.initElm && te(t, e);
